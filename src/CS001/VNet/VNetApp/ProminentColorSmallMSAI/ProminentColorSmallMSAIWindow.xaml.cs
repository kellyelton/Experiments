...
public partial class ProminentColorSmallMSAIWindow : Window
{
    public ProminentColorSmallMSAIViewModel ViewModel {
        get => (ProminentColorSmallMSAIViewModel)GetValue(ViewModelProperty);
        set => SetValue(ViewModelProperty, value);
    }

    public static readonly DependencyProperty ViewModelProperty =
        DependencyProperty.Register(nameof(ViewModel), typeof(ProminentColorSmallMSAIViewModel), typeof(ProminentColorSmallMSAIWindow), new PropertyMetadata(null));
    ...
    public ProminentColorSmallMSAIWindow() {
        ViewModel = new ProminentColorSmallMSAIViewModel(1, 3);
